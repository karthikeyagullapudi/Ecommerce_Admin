...
function createData(id, category, subcategory, brand, coupon) {
    return { id, category, subcategory, brand, coupon };
}

const rows = [
    createData(1, 'Electronics', 'Mobile', 'Samsung', 'ELEC10'),
    createData(2, 'Fashion', 'Men Clothing', 'Nike', 'FASH20'),
    createData(3, 'Home Appliances', 'Kitchen', 'Philips', 'HOME15'),
    createData(4, 'Books', 'Fiction', 'Penguin', 'BOOK5'),
    createData(5, 'Toys', 'Educational', 'Lego', 'TOY25'),
];

export default function CouponsCategoryTable() {
    return (
        <TableContainer component={Paper} sx={{ marginTop: 4 }}>
            <Table sx={{ minWidth: 750 }} aria-label="category table">
                <TableHead>
